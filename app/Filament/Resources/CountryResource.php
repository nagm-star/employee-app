...
class CountryResource extends Resource
{
    ...
    protected static ? string $navigationLabel = 'Country'; // change label
    ...
    protected static ? int $navigationSort = 1; // sort on top of menu
    ...
    {
        return [
            StatesRelationManager::class, // GET STATE RELATED TO THIS COUNTRY
